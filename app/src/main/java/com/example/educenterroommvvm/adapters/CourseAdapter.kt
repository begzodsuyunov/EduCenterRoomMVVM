package com.example.educenterroommvvm.adapters
...
class CourseAdapter : ListAdapter<CourseData, CourseAdapter.CourseViewHolder>(CallBack) {
    ...
    object CallBack : DiffUtil.ItemCallback<CourseData>() {
